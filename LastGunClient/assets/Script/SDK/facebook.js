...
//视频广告ID
var video_ad_ids        = '603253110050604_603265710049344';
//插屏广告ID
var interstitial_ad_ids = '603253110050604_603265483382700';
//游戏ID
var game_id             = "603253110050604";
...
FB_SDK.prototype.doShare = function(score) {
    var self = this;
    var en_text = self.getName() + "Get the amazing weapon shooting!";
    var cn_text = self.getName() + "使用强力的武器来射击吧！";
